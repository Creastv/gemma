<div class="navbar__swicher">
    <svg xmlns="http://www.w3.org/2000/svg" width="38.326" height="33" viewBox="0 0 38.326 33">
        <g id="Moduł_języka" transform="translate(-39.49 2.519)">
            ...
            <path id="Shape_14" data-name="Shape 14" d="M1681.592,41.652V40.436l-4.519,5.334-4.519-5.334v1.216l4.519,5.333Z" transform="translate(-1603.776 -29.373)" fill="#535353" />
        </g>
    </svg>
