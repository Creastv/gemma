...
<div class="search-resoults-info">
    <div class="search-results-count">
        <span> Znaleziono <?php echo $loop->found_posts; ?> <?php echo $loop->found_posts; ?>  <?php if($loop->found_posts == '1')  { echo 'wynik'; } else if($loop->found_posts >= '1' && $loop->found_posts <= '4' ) { echo 'wyniki'; } else { echo 'wyników'; } ;?> wyszukiwania. </span>
    </div>
